...
export const UiTokens = Object.freeze({
  color: Object.freeze({
    ...
    blue: new Color(68, 150, 236, 255),
    orange: new Color(246, 142, 44, 255),
    purple: new Color(160, 86, 224, 255),
    cyan: new Color(58, 186, 202, 255),
    amber: new Color(244, 172, 32, 255),
    pink: new Color(238, 86, 142, 255),
    rework: new Color(226, 64, 54, 255),
    hunt: new Color(108, 82, 224, 255),
